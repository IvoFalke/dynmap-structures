...
public class DynmapStructuresPlugin extends JavaPlugin implements Listener {
    ...
    public void onEnable() {
        ...
        BIOMES[FROZEN_OCEAN.ordinal()] = new StructureType[] { BURIED_TREASURE, MINESHAFT, OCEAN_RUIN, SHIPWRECK,
                STRONGHOLD };
        BIOMES[FROZEN_RIVER.ordinal()] = new StructureType[] { MINESHAFT, STRONGHOLD };
        try {
            BIOMES[Biome.valueOf("SNOWY_TUNDRA").ordinal()] = new StructureType[] { IGLOO, MINESHAFT, STRONGHOLD,
                    VILLAGE };
        } catch (IllegalArgumentException e) {
        }
        try {
        ...
        try {
            BIOMES[Biome.valueOf("DESERT_HILLS").ordinal()] = new StructureType[] { DESERT_PYRAMID, MINESHAFT,
                    STRONGHOLD, VILLAGE };
        } catch (IllegalArgumentException e) {
        }
        try {
        ...
        try {
            BIOMES[Biome.valueOf("JUNGLE_HILLS").ordinal()] = new StructureType[] { JUNGLE_PYRAMID, MINESHAFT,
                    STRONGHOLD };
        } catch (IllegalArgumentException e) {
        }
        try {
            BIOMES[Biome.valueOf("JUNGLE_EDGE").ordinal()] = new StructureType[] { JUNGLE_PYRAMID, MINESHAFT,
                    STRONGHOLD };
        } catch (IllegalArgumentException e) {
        }
        try {
        ...
        BIOMES[DEEP_OCEAN.ordinal()] = new StructureType[] { BURIED_TREASURE, MINESHAFT, OCEAN_MONUMENT, OCEAN_RUIN,
                SHIPWRECK, STRONGHOLD };
        try {
            BIOMES[Biome.valueOf("STONE_SHORE").ordinal()] = new StructureType[] { BURIED_TREASURE, MINESHAFT,
                    OCEAN_RUIN, SHIPWRECK, STRONGHOLD };
        } catch (IllegalArgumentException e) {
        }
        try {
            Biome.valueOf("STONY_SHORE");
            BIOMES[STONY_SHORE.ordinal()] = new StructureType[] { BURIED_TREASURE, MINESHAFT, OCEAN_RUIN, SHIPWRECK,
                    STRONGHOLD };
        } catch (IllegalArgumentException e) {
            getLogger().warning("STONY_SHORE not supported.");
        }
        BIOMES[SNOWY_BEACH.ordinal()] = new StructureType[] { BURIED_TREASURE, MINESHAFT, OCEAN_RUIN, SHIPWRECK,
                STRONGHOLD };
        ...
        try {
            BIOMES[Biome.valueOf("SNOWY_TAIGA_HILLS").ordinal()] = new StructureType[] { MINESHAFT, STRONGHOLD,
                    VILLAGE };
        } catch (IllegalArgumentException e) {
        }
        try {
        ...
        BIOMES[WARM_OCEAN.ordinal()] = new StructureType[] { BURIED_TREASURE, MINESHAFT, OCEAN_RUIN, SHIPWRECK,
                STRONGHOLD };
        BIOMES[LUKEWARM_OCEAN.ordinal()] = new StructureType[] { BURIED_TREASURE, MINESHAFT, OCEAN_RUIN, SHIPWRECK,
                STRONGHOLD };
        BIOMES[COLD_OCEAN.ordinal()] = new StructureType[] { BURIED_TREASURE, MINESHAFT, OCEAN_RUIN, SHIPWRECK,
                STRONGHOLD };
        try {
            BIOMES[Biome.valueOf("DEEP_WARM_OCEAN").ordinal()] = new StructureType[] { BURIED_TREASURE, MINESHAFT,
                    OCEAN_MONUMENT, OCEAN_RUIN, SHIPWRECK, STRONGHOLD };
        } catch (IllegalArgumentException e) {
        }
        BIOMES[DEEP_LUKEWARM_OCEAN.ordinal()] = new StructureType[] { BURIED_TREASURE, MINESHAFT, OCEAN_MONUMENT,
                OCEAN_RUIN, SHIPWRECK, STRONGHOLD };
        BIOMES[DEEP_COLD_OCEAN.ordinal()] = new StructureType[] { BURIED_TREASURE, MINESHAFT, OCEAN_MONUMENT,
                OCEAN_RUIN, SHIPWRECK, STRONGHOLD };
        BIOMES[DEEP_FROZEN_OCEAN.ordinal()] = new StructureType[] { BURIED_TREASURE, MINESHAFT, OCEAN_MONUMENT,
                OCEAN_RUIN, SHIPWRECK, STRONGHOLD };
        BIOMES[THE_VOID.ordinal()] = new StructureType[] {};
        BIOMES[SUNFLOWER_PLAINS.ordinal()] = new StructureType[] { MINESHAFT, STRONGHOLD, VILLAGE };
        try {
            BIOMES[Biome.valueOf("DESERT_LAKES").ordinal()] = new StructureType[] { DESERT_PYRAMID, MINESHAFT,
                    STRONGHOLD, VILLAGE };
        } catch (IllegalArgumentException e) {
        }
        try {
        ...
        try {
            BIOMES[Biome.valueOf("MODIFIED_JUNGLE").ordinal()] = new StructureType[] { JUNGLE_PYRAMID, MINESHAFT,
                    STRONGHOLD };
        } catch (IllegalArgumentException e) {
        }
        try {
            BIOMES[Biome.valueOf("MODIFIED_JUNGLE_EDGE").ordinal()] = new StructureType[] { JUNGLE_PYRAMID, MINESHAFT,
                    STRONGHOLD };
        } catch (IllegalArgumentException e) {
        }
        try {
        ...
        try {
            BIOMES[Biome.valueOf("DARK_FOREST_HILLS").ordinal()] = new StructureType[] { MINESHAFT, STRONGHOLD,
                    WOODLAND_MANSION };
        } catch (IllegalArgumentException e) {
        }
        try {
            BIOMES[Biome.valueOf("SNOWY_TAIGA_MOUNTAINS").ordinal()] = new StructureType[] { MINESHAFT, STRONGHOLD,
                    VILLAGE };
        } catch (IllegalArgumentException e) {
        }
        try {
        ...
        try {
            BIOMES[Biome.valueOf("MODIFIED_GRAVELLY_MOUNTAINS").ordinal()] = new StructureType[] { MINESHAFT,
                    STRONGHOLD };
        } catch (IllegalArgumentException e) {
        }
        try {
            BIOMES[Biome.valueOf("SHATTERED_SAVANNA").ordinal()] = new StructureType[] { MINESHAFT, STRONGHOLD,
                    VILLAGE };
        } catch (IllegalArgumentException e) {
        }
        try {
        ...
        try {
            BIOMES[Biome.valueOf("SHATTERED_SAVANNA_PLATEAU").ordinal()] = new StructureType[] { MINESHAFT, STRONGHOLD,
                    VILLAGE };
        } catch (IllegalArgumentException e) {
        }
        BIOMES[ERODED_BADLANDS.ordinal()] = new StructureType[] { MINESHAFT, STRONGHOLD };
        try {
            BIOMES[Biome.valueOf("MODIFIED_WOODED_BADLANDS_PLATEAU").ordinal()] = new StructureType[] { MINESHAFT,
                    STRONGHOLD };
        } catch (IllegalArgumentException e) {
        }
        try {
            BIOMES[Biome.valueOf("MODIFIED_BADLANDS_PLATEAU").ordinal()] = new StructureType[] { MINESHAFT,
                    STRONGHOLD };
        } catch (IllegalArgumentException e) {
        }
        try {
        ...
        try {
            BIOMES[Biome.valueOf("BAMBOO_JUNGLE_HILLS").ordinal()] = new StructureType[] { JUNGLE_PYRAMID, MINESHAFT,
                    STRONGHOLD };
        } catch (IllegalArgumentException e) {
        }
        try {
        ...
        try {
            ...
            BIOMES[CUSTOM.ordinal()] = new StructureType[] { BASTION_REMNANT, BURIED_TREASURE, DESERT_PYRAMID, END_CITY,
                    NETHER_FORTRESS, IGLOO, JUNGLE_PYRAMID, WOODLAND_MANSION, MINESHAFT, NETHER_FOSSIL, OCEAN_MONUMENT,
                    OCEAN_RUIN, PILLAGER_OUTPOST, RUINED_PORTAL, SHIPWRECK, STRONGHOLD, SWAMP_HUT, VILLAGE };
        } catch (IllegalArgumentException e) {
        ...
        if (Bukkit.getPluginManager().isPluginEnabled("dynmap")) {
            ...
            for (StructureType type : StructureType.getStructureTypes().values()) {
                ...
                if (set != null) {
                    ...
                    for (StructureType ltype : StructureType.getStructureTypes().values()) {
                        String id = ltype.getName().toLowerCase(Locale.ROOT).replace("_", "");
            ...
            if (world != null) {
                ...
                if (biome != null) {
                    ...
                    for (StructureType type : BIOMES[biome.ordinal()]) {
                        try {
                            // getLogger().warning("run for type" + type.getName());
                            if (STRUCTURES.get(type)) {
                                Location structure;
                                try {
                                    structure = location.getWorld().locateNearestStructure(location, type, 1, false);
                                } catch (ConcurrentModificationException e) {
                                    getLogger().warning("Skipping locate at ([" + location.getWorld().getName() + "], "
                                            + location.getBlockX() + ", " + location.getBlockZ()
                                            + ") due to concurrent modification exception.");
                                    return;
                                } catch (NullPointerException e) {
                                    getLogger().warning("Skipping locate at ([" + location.getWorld().getName() + "], "
                                            + location.getBlockX() + ", " + location.getBlockZ()
                                    ...
                                    try {
                                        if (!noLabels) {
                                            ...
                                            if (Bukkit.getPluginManager().isPluginEnabled("dynmap")) {
                                                // Set up our Dynmap api
                                                try {
                                                    DynmapCommonAPI plugin = (DynmapCommonAPI) Bukkit.getPluginManager()
                                                            .getPlugin("dynmap");
                                                    if (plugin != null) {
                                                        api = plugin.getMarkerAPI();
                                                    }
                                                ...
                                                if (api == null) {
                                                    getLogger().warning("RUN Api is null!");
                                                    return;
                                                } else {
                                                    ...
                                                    if (set != null) {
                                                        // getLogger().warning("RUN MARKERICON: >> structures." + id + "
                                                        // <<");
                                                        set.createMarker(id + "," + x + "," + z, label, world.getName(),
                                                                x, 64,
                                                                z, api.getMarkerIcon("structures." + id), true);
                                                    }
                                                }
                                            }
                                        }
                                    } catch (Exception e) {
                                        getLogger().warning("run Label is NULL: id: " + id);
                                    }
                            ...
                            getLogger().warning(
                                    "Exception in Run: LABELS.get(type);: " + LABELS.get(type) + " STACK: " + e);
                        }
                        // getLogger().warning("run exit for type" + type.getName());
